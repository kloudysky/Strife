...
export default class CreateServer extends React.Component {
  ...
  handleFormSubmit(e) {
    ...
    //           .then(() => {
    //             this.props
    //               .fetchChannels(action.server.server.id)
    //               .then((action2) => {
    //                 let thisChannelId = Object.values(action2.channels)[0].id;
    //                 this.props.history.push(
    //                   `/channels/${thisServerId}/${thisChannelId}`
    //                 );
    //               });
    //           });
    //       });
  ...
  render() {
    let createServerClass = this.props.modalState
      ? "create-server-modal"
      : "create-server-modal inactive";
    let screenClass = "";
    ...
    let second = this.state.joiningServer ? (
      <div className="second-screen join">
        ...
        <div className="form-container">
          <label className={linkClass} htmlFor="code">
            INVITE LINK {linkHeader}
          </label>
          <input
            name="code"
            type="text"
      ...
      <div className="second-screen">
        ...
        <div className="skip-div">
          <h2>
            Not sure? You can{" "}
            <a onClick={this.forwardScreen}>skip this question</a> for now
          </h2>
        </div>
            ...
            <div className="third-screen">
              ...
              <form>
                ...
                <div className="name-input-div">
                  ...
                  <h3>
                    By creating a server, you agree to discords{" "}
