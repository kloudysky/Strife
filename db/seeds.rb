...
Channel.create(channel_name: "bombing mission", server_id: 3, channel_type: 0, owner_id: 3)
Channel.create(channel_name: "training", server_id: 2, channel_type: 0, owner_id: 4)
Channel.create(channel_name: "Sephiroth", server_id: 4, channel_type: 0, owner_id: 9)
Channel.create(channel_name: "slums", server_id: 1, channel_type: 0, owner_id: 2)
